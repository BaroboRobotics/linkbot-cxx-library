...
public:
    ...
    void setJointMovementStateTime(LinkbotJoint id, LinkbotDirection dir, double seconds);
    void setJointMovementStateTimeNB(LinkbotJoint id, LinkbotDirection dir, double seconds);
    #if 0 //TODO 
